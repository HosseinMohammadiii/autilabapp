                  ...
                  builder: (context, constraints) {
                    ...
                    return CustomScrollView(
                      slivers: [
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  child: Text(
                                    'See All',
                                    style:
                                        AutilabTextStyle.medium14_500.copyWith(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  CustomButtonWidget(
                                    ...
                                    onTap: () {
                                      context
                                          .goNamed(AutiLabRoutes.doctorScreen);
                                    },
                                    height: 50,
                                  ...
                                  return Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: NewAppointmentsCardWidget(
                                        ...
                                        isMobile: isMobile(),
                                        color:
                                            statusCheckColor(statusList[index])
                                                .$3,
                                        title:
                                            statusCheckColor(statusList[index])
                                                .$2,
                        ...
                        SliverPadding(
                          padding:
                              AutilabMargin.marginFullScreen.copyWith(left: 16),
                          sliver: SliverToBoxAdapter(
                            child: Visibility(
