      ...
      builder: (context, constraints) {
        ...
        return ResponsiveLayout(
          child: FadeTransition(
            ...
            child: BlocConsumer<ProfileBlocLocal, AuthenticationState>(
                          ...
                          child: Column(
                            children: [
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Visibility(
                                        ...
                                        replacement: CachednetworkimageWidget(
                              ...
                              Text(
                                ...
                                '${userParam?.firstName ?? 'Dina'} ${userParam?.lastName ?? 'Olise'}',
                              ...
                              Text(
                                // ' response.email,',
                                userParam?.email ?? 'test@example.com',
                          ...
                          widget: Text(
                            selectedGender == 'male'
                                ...
                                : selectedGender == 'female'
                                    ...
                                    : 'Select your gender',
                            style: AutilabTextStyle.small14_400.copyWith(
                              color: selectedGender == 'Select your gender'
                                  ? AutilabColor.gray
                                  : AutilabColor.black,
                              fontSize: isMobile() ? 14 : 20,
                            ),
