...
class _QuizAndSelectAnswerScreenState extends State<QuizAndSelectAnswerScreen>
  ...
  Future<int> loadIntelligenceId() async {
    return await SharedPreferencesData.getQuestionId();
  }
        ...
        return ResponsiveLayout(
          child: FadeTransition(
            ...
            child: PopScope(
              ...
              child: FutureBuilder(
                future: loadIntelligenceId(),
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    return const LoadingProgressWidget();
                  }
                  intelligenceId = snapshot.data! + 1;
                    ...
                    child: BlocConsumer<TestBloc, TestState>(
                      listener: (context, state) {
                        if (state is IntelligenceAnswerState) {
                          SharedPreferencesData.setQurstionId(state.message);
